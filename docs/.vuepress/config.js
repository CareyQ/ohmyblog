...
module.exports = {
  title: "Oh! My Blog",
  description: '天生骄傲', // 描述,以 <meta> 标签渲染到页面html中
  ...
  themeConfig: { // 主题配置
    ...
    repo: 'ourongxing/ourongxing.github.io', // 导航栏右侧生成Github链接
    ...
    author: { // 文章默认的作者信息，可在md文件中单独配置此信息 String | {name: String, link: String}
      name: 'ourongxing', // 必需
      link: 'https://github.com/ourongxing' // 可选的
    },
    ...
    social:{ // 社交图标，显示于博主信息栏和页脚栏
      // iconfontCssFile: '//at.alicdn.com/t/font_1937198_pca1kca9y5.css', // 可选，阿里图标库在线css文件地址，对于主题没有的图标可自由添加
      icons: [
        {
